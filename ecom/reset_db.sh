...
# echo "from store.models import User; User.objects.create_superuser('acraiders', 'acraiders@gmail.com', 'acr@2004')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='rampreetham', email='rampreethamkanchi@gmail.com', password='ramu@2004')" | python manage.py shell
# creating users
echo "from store.models import User; User.objects.create_superuser(username='acraiders', email='acraiders@gmail.com', password='acr@2004', first_name='acraiders', last_name='owner')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='rampreetham', email='rampreethamkanchi@gmail.com', password='xyz@2004', first_name='Ram Preetham', last_name='Kanchi')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='jaswanth', email='jaswanth@gmail.com', password='xyz@2004', first_name='Jaswanth', last_name='Mantri')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='varun', email='varun@gmail.com', password='xyz@2004', first_name='Varun', last_name='Mupparaju')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='nishnath', email='nishnath@gmail.com', password='xyz@2004', first_name='Nishnath', last_name='Parimi')" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='karthikeya', email='karthikeya@gmail.com', password='xyz@2004', first_name='Karthikeya', last_name='Poondla')" | python manage.py shell
echo "from store.models import User; user = User.objects.create(username='karthikeya', email='karthikeya@gmail.com', first_name='Karthikeya', last_name='Poondla'); user.set_password('xyz@2004'); user.save()" | python manage.py shell
echo "from store.models import User; user = User.objects.create(username='rampreetham',email = 'rampreetham@gmail.com', first_name='Rampreetham', last_name='Kanchi'); user.set_password('xyz@2004'); user.save()" | python manage.py shell
echo "from store.models import User; user = User.objects.create(username='jaswanth',email = 'jaswanth@gmail.com', first_name='Jaswanth', last_name='Mantri'); user.set_password('xyz@2004'); user.save()" | python manage.py shell
echo "from store.models import User; user = User.objects.create(username='varun',email = 'varun@gmail.com', first_name='Varun', last_name='Mupparaju'); user.set_password('xyz@2004'); user.save()" | python manage.py shell
echo "from store.models import User; user = User.objects.create(username='nishnath',email = 'nishnath@gmail.com', first_name='Nishnath', last_name='Parimi'); user.set_password('xyz@2004'); user.save()" | python manage.py shell
# echo "from store.models import User; User.objects.create(username='vamshi', email='rampreethamkanchi@gmail.com', password='ramu@2004', first_name='Vamshi', last_name='Krishna')" | python manage.py shell
# create a customer for the superuser , with city and phone
# echo "from store.models import User; from store.models import Customer; Customer.objects.create(user=User.objects.get(username='acraiders'), phone='9032232817')" | python manage.py shell
# echo "from store.models import User; from store.models import Customer; Customer.objects.create(user=User.objects.get(username='rampreetham'), phone='9032256780')" | python manage.py shell
#creating some customers from users
echo "from store.models import User; from store.models import Customer; Customer.objects.create(user=User.objects.get(username='jaswanth'), phone='9032256780')" | python manage.py shell
echo "from store.models import User; from store.models import Customer; Customer.objects.create(user=User.objects.get(username='varun'), phone='9032256781')" | python manage.py shell
echo "from store.models import User; from store.models import Customer; Customer.objects.create(user=User.objects.get(username='nishnath'), phone='9032256782')" | python manage.py shell
...
echo "from store.models import User; from store.models import Customer; from store.models import Address; Address.objects.create(customer=Customer.objects.get(user=User.objects.get(username='jaswanth')), city='Nellore', state='Andhra Pradesh', pincode='500072', street='Kanchi Nagar', house_no='12/543/1')" | python manage.py shell
echo "from store.models import User; from store.models import Customer; from store.models import Address; Address.objects.create(customer=Customer.objects.get(user=User.objects.get(username='varun')), city='Hyderabad', state='Telegana', pincode='500073', street='Mupparaju Nagar', house_no='12/543/2')" | python manage.py shell
echo "from store.models import User; from store.models import Customer; from store.models import Address; Address.objects.create(customer=Customer.objects.get(user=User.objects.get(username='nishnath')), city='Nellore', state='Andhra Pradesh', pincode='500072', street='Parimi Nagar', house_no='12/543/3')" | python manage.py shell
#     def __str__(self):
#         return self.city
#     class Meta:
...
echo "from store.models import User; from store.models import Manager; Manager.objects.create(user=User.objects.get(username='rampreetham'),gender='male',phone='9032256785',city='Nellore', state='Andhra Pradesh', pincode='500072', street='Kanchi Nagar', dob='2004-04-20', locality='Kanchi Nagar')" | python manage.py shell
echo "from store.models import User; from store.models import Manager; Manager.objects.create(user=User.objects.get(username='karthikeya'), gender='male',phone='9032256786',city='Hyderabad', state='Telangana', pincode='500073', street='Poondla Nagar', dob='2004-04-21', locality='Poondla Nagar', house_no='12/543/1')" | python manage.py shell 
